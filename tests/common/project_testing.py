...
BRENT_SOL005_DIR = 'sol005'
BRENT_SOL005_SCRIPTS_DIR = 'scripts'
BRENT_SOL005_CREATE_NS_REQUEST_FILE = 'CreateNsRequest.js'
BRENT_SOL005_HEAL_NS_REQUEST_FILE = 'HealNsRequest.js'
BRENT_SOL005_INSTANTIATE_NS_REQUEST_FILE = 'InstantiateNsRequest.js'
BRENT_SOL005_UPDATE_NS_REQUEST_START_FILE = 'UpdateNsRequest-Start.js'
BRENT_SOL005_UPDATE_NS_REQUEST_STOP_FILE = 'UpdateNsRequest-Stop.js'
BRENT_SOL005_SCALE_NS_REQUEST_FILE = 'ScaleNsRequest.js'
BRENT_SOL005_TERMINATE_NS_REQUEST_FILE = 'TerminateNsRequest.js'
BRENT_SOL005_NS_INSTANCE_FILE = 'NsInstance.js'
BRENT_RESTCONF_DIR = 'restconf'
BRENT_RESTCONF_SCRIPTS_DIR = 'template'
BRENT_RESTCONF_CREATE_REQUEST_FILE = 'Create.xml'
BRENT_RESTCONF_UPDATE_REQUEST_FILE = 'Update.xml'
BRENT_RESTCONF_DELETE_REQUEST_FILE = 'Delete.xml'
BRENT_NETCONF_DIR = 'netconf'
BRENT_NETCONF_SCRIPTS_DIR = 'template'
BRENT_NETCONF_RSA_DIR = 'keys'
BRENT_NETCONF_RSA_FILE = 'id_rsa'
BRENT_NETCONF_CREATE_REQUEST_FILE = 'Create.xml'
BRENT_NETCONF_UPDATE_REQUEST_FILE = 'Update.xml'
BRENT_NETCONF_DELETE_REQUEST_FILE = 'Delete.xml'
