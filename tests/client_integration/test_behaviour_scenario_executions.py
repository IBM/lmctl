...
class TestBehaviourScenarioExecutionsAPI(ClientIntegrationTest):
    ...
    def _create_scenario(self, name_suffix: str):
        ...
        scenario = self.tester.load_behaviour_scenario_from(self.tester.test_file('metric_scenario.json'))
