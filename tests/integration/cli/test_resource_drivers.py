...
class TestResourceDrivers(CLIIntegrationTest):
    ...
    def test_delete_with_ignore_missing(self):
        ...
        self.assert_output(delete_result, f'(Ignored) 404 Client Error:  for url: {self.tester.default_client.address}/api/resource-manager/resource-drivers/NonExistentObj')