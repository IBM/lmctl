...
class LmResourceDriverMgmtDriver(LmDriver):
    ...
    def __resource_drivers_api(self):
        return '{0}/api/v1/resource-manager/resource-drivers'.format(self.lm_base)

    def __resource_drivers_by_type_api(self, driver_type):
        return '{0}/api/v1/resource-manager/resource-drivers?type={1}'.format(self.lm_base, driver_type)

    def __resource_driver_by_id_api(self, driver_id):
        return '{0}/api/v1/resource-manager/resource-drivers/{1}'.format(self.lm_base, driver_id)
