...
class LmVimDriverMgmtDriver(LmDriver):
    ...
    def __vim_drivers_api(self):
        return '{0}/api/v1/resource-manager/vim-drivers'.format(self.lm_base)

    def __vim_drivers_by_type_api(self, inf_type):
        return '{0}/api/v1/resource-manager/vim-drivers?infrastructureType={1}'.format(self.lm_base, inf_type)

    def __vim_driver_by_id_api(self, driver_id):
        return '{0}/api/v1/resource-manager/vim-drivers/{1}'.format(self.lm_base, driver_id)
