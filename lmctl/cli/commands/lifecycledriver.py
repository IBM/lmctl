...
@click.group(hidden=True, short_help='Use "lmctl create/get/delete resourcedriver"', help='deprecated in v3.0: Commands for managing Lifecycle drivers (CP4NA orchestration 2.1 only)')
def lifecycledriver():
