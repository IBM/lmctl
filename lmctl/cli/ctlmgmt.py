...
def create_lm_session(environment_group_name = None, lm_pwd=None, config_path=None, lm_client_secret=None, lm_token=None):
    ...
    controller = get_global_controller(override_config_path=config_path)

    lm = controller.get_tnco_env(environment_group_name, lm_pwd, lm_client_secret, lm_token)

    return lm.create_session()
